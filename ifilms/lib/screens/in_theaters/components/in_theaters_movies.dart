...
class InTheatersMovies extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    return Observer(builder: (_) {
      return ListView.separated(
          ...
          itemCount: _inTheatersStore.moviesInTheaters.mediaDetails.length,
          itemBuilder: (context, index) {
            final mediaType =
                _inTheatersStore.moviesInTheaters.mediaDetails[index];
