...
import 'sample_SN_RP/presentation/dummies/sample_home_screen.dart' as _i4;
import 'sample_SN_RP/presentation/dummies/sample_login_screen.dart' as _i3;
import 'sample_SN_RP/presentation/dummies/sample_splash_screen.dart' as _i2;
import 'sample_SN_RP/presentation/smarties/sample_smart_view.dart' as _i1;
...
class AppRouter extends _i5.RootStackRouter {
  ...
  List<_i5.RouteConfig> get routes => [
        _i5.RouteConfig(
          SampleSmartViewRoute.name,
          path: '/',
          children: [
            _i5.RouteConfig(
              SampleSplashScreenRoute.name,
              path: 'splash',
              parent: SampleSmartViewRoute.name,
            ),
            _i5.RouteConfig(
              SampleLoginScreenRoute.name,
              path: 'login',
              parent: SampleSmartViewRoute.name,
            ),
            _i5.RouteConfig(
              SampleHomeScreenRoute.name,
              path: 'home',
              parent: SampleSmartViewRoute.name,
            ),
          ],
